...
public class TransitRunner
{
    ...
    public static MetroRoute instantiateMetroSystem()
    {
        ...
        //Notice how above, the last station is also the second station (kinda -- they are technically separate objects)
        //We don't have to arrange our stops like this, this just tends to be how train stations are arranged (since they reuse the same rail and same stations in both directions)
